<svelte:head>
	<title>WATCH ::: ISTRAV</title>
</svelte:head>

<script>
  import { onMount } from 'svelte'
  import Watch from '../../../../../../components/Apps/Videos/Watch.svelte'
...
<Sidebar domain={domain} state={state} active="videos">
  <Navigation>
  ...
  <div style="min-height: 100vh;">
    ...
    <br />
    {#if load}
      <Watch domain={domain} state={state} slugId={slug}  />
    {/if}
    <br />
    <br />
    <br />
