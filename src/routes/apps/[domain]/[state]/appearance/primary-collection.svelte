...
<script>
  ...
  import Change from '../../../../../components/Apps/Appearance/PrimaryCollection.svelte'
...
<Sidebar domain={domain} state={state} active="appearance">
  <Navigation>
  ...
  <div style="min-height: 100vh;">
    ...
    <br />
    {#if load === true}
      <Change domainId={domain} stateId={state} />
    {/if}
    <br />
    <br />
    <br />
