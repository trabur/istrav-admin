<script>
  ...
  onMount(async () => {
    ...
    if (esOne.payload.success === true) {
      ...
      let esAll = await scripts.channel.playlists.getAll(appId)
...
<div class="row">
  ...
  <div class="col s12 m10">
    ...
    <div class="card">
      <a href={`/apps/${domain}/${state}/playlists/add`} class="floating-add btn-floating btn-large waves-effect waves-light"><i class="material-icons">add</i></a> 
      <div class="list">
        {#if table.length}
          <table>
            <thead>
