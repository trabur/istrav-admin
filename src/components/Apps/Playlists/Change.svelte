...
<script>
  ...
  let endpoint
    ...
    let esUpdate = await scripts.channel.playlists.getUpdate(appId, token, slugId, change)
  ...
  onMount(async () => {
    ...
    if (esOne.payload.success === true) {
      ...
      let esGuide = await scripts.channel.playlists.getOne(appId, slug)
  ...
  function upload() {
    ...
    formData.append('folder', `playlists/${slug}`)
...
<div class="row">
  ...
  <div class="col s12 m10">
    ...
    <div class="card" style="padding: 1em; overflow: hidden; background-color: #ccc;">
      <a href={`/apps/${domain}/${state}/menus`} class="waves-effect btn" style="float: left; margin-right: 0.5em;">⟵ BACK</a>
      <h3 class="path">/{slugId}</h3>
      <div style="text-align: right;">
        <Delete appId={appId} slug={slugId} domain={domain} state={state} />
        <a href={`http://${endpoint}.tyu67.com/menus/${slugId}`} class="waves-effect btn right teal" style="margin-right: 1em;" target="_blank"><i class="navicon material-icons">public</i></a>
      </div>
    </div>
  </div>
  <div class="col s0 m1"></div>
...
<div class="row">
  ...
  <div class="col s12 m3">
    <Sidebar domain={domain} state={state} slug={slug} active="playlists" />
  </div>
  <div class="col s12 m7">
    ...
    <div class="card" style="padding: 1em;">
      <div class="row">
        ...
        <a href={`/apps/${domain}/${state}/playlists/${slugId}/guides`} style="margin-right: 1em;" class="right waves-effect btn"><i class="material-icons">ondemand_video</i></a>
      </div>
    </div>
  </div>
  <div class="col s12 m1"></div>
