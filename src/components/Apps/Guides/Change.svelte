...
<script>
  ...
  let uploads
    ...
    let esUpdate = await scripts.channel.guide.getUpdate(appId, token, slugId, change)
  ...
  <div class="col s12 m4">
    ...
    <div class="card" style="padding: 1em;">
      <div class="row">
        ...
        <img src={`https://rawcdn.githack.com/${uploads}/${domain}/${state}/guides/${slug}/${image}`} alt="" style="width: 100%;" />
        <br />
